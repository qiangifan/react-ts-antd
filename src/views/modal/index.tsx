...
import {modalVisibleHandle} from '../../redux/action'
...
const easyStyle = {
    ...
    const deleteBaseOpt = {
        ...
        export class CommonModal extends React.Component < any,
        any > {
            state = {
                name: "111"
            }
                ...
                return (
                    <div>
                        ...
                        <div style={easyStyle}>
                            ...
                            <Button onClick={this.input}>输入state</Button>
        ...
        export default connect(store => store)(CommonModal);